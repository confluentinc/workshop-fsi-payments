...
output "customer_risk_exposure_table_name" {
  value = var.enable_materialized_tables ? confluent_flink_materialized_table.customer_risk_exposure[0].display_name : var.customer_risk_exposure_table_name
}
